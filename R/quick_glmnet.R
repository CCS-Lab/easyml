...
#'
#' @param dat_path path to a data file
#' @param dependentVar dependent variable
#' @param depCate category of DV: "binary" or "continuous"
#' @param excludeVar any variables to exlcude?
#' @param categoricalVar any categorical variables?
#' @param numIterations Default=1000. Number of iterations
#' @param header Does the data file have a header? T or F
#' @param outOfSample out-of-sample predictions? T or F
#' @param splitBy Default=3. Use 1/splitBy e.g. 33 percent of data as a test set
#' @param whichSeq Default=1. Which sequence to use for a test set? 1, 2, or 3
#' @param myAlpha Default=1. myAlpha=1 for LASSO
#' @param nFolds Default=5. k-fold
#' @param survivalRate_cutoff cutoff to be included in the beta matrix
#' @return TO BE EDITED.
#' @export
quick_glmnet <- function(dat_path = NULL, dependentVar = NULL, depCate = NULL, 
                         excludeVar = NULL, categoricalVar = NULL,
                         numIterations = 1000, header = T, outOfSample = T,
                         splitBy  = 3, whichSeq = 1, myAlpha = 1, nFolds  = 5,
                         survivalRate_cutoff = 0.05) { 
  # Detect OS
