...
#' \item{model_performance_train}{A vector of length n_divisions; the mean train metrics.}
#' \item{metrics_test}{A vector of length n_divisions; the mean test metrics.}
#' \item{plot_model_performance}{A function; the function for plotting metrics generated by scoring the model.}
#' \item{plot_model_performance_train}{A ggplot object; the plot of the mean train metrics.}
#' \item{plot_model_performance_test}{A ggplot object; the plot of the mean test metrics.}
#' }
#' @family recipes
#' @export
easy_analysis <- function(.data, dependent_variable, algorithm, 
  ...
  if (metrics) {
    ...
    metrics_test <- mets[["metrics_test"]]
    ...
    plot_model_performance_test <- plot_model_performance(metrics_test) + 
      ggplot2::labs(subtitle = "Test Dataset")
